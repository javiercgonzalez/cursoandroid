    ...
    private void acciones() {
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!(editOp1.getText().toString().isEmpty() || editOp2.getText().toString().isEmpty())){
                    switch (operacion) {
                        case 1:
                    ...
                    Toast.makeText(getApplicationContext(),"Falta uno de los operadores",Toast.LENGTH_SHORT).show();
                }
            }
        });
